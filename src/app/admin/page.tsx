...
import { Edit, BookOpenText } from "lucide-react"; // Added BookOpenText
    ...
    <div>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="font-body">
            Current functionalities: View and manage booking requests, edit house rules and house guide.
          </p>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription className="font-body">
            Edit text content for various pages of your website.
          </CardDescription>
        </CardHeader>
