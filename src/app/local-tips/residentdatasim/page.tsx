...
export default function ResidentDataSimInfographic() {
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      setTimeout(() => {
        const prepaid = document.getElementById('prepaidRiskChart');
        const rollover = document.getElementById('rolloverBenefitChart');
        const initial = document.getElementById('initialCostChart');
        const topup = document.getElementById('topUpCostChart');
        if (window.Chart && prepaid && rollover && initial && topup) {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 font-sans text-gray-800">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-black text-primary mb-2">The Quest for the Non-Expiring Data SIM (For Residents)</h1>
