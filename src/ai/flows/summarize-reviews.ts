// Summarize reviews of nearby restaurants and attractions.

'use server';

/**
 * @fileOverview Summarizes online reviews of restaurants and attractions.
 *
...
const SummarizeReviewsInputSchema = z.object({
  placeName: z.string().describe('The name of the restaurant or attraction.'),
  reviews: z.string().describe('Online reviews of the place.'),
});
...
const summarizeReviewsPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following reviews for {{placeName}}:\n\nReviews: {{{reviews}}}`,
});
